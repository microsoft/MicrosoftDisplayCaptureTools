...
MODULE_SETUP(ModuleSetup)
{
    ...
    if (!winrt::RuntimeSettings().GetSettingValueAsBool(RunPredictionOnlyRuntimeParameter))
    {
        ...
        g_displayMap = g_framework.GetSourceToSinkMappings(false, displayEngineForMapping, toolboxForMapping, nullptr, nullptr);
        if (g_displayMap.Size() == 0)
        {
            ...
            g_displayMap = g_framework.GetSourceToSinkMappings(true, displayEngineForMapping, toolboxForMapping, nullptr, nullptr);
